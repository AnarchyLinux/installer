...
export version="arch-anywhere-2.1.4-dual.iso"

# Set the ISO label here
export iso_label="ARCH_ANYWHERE_2.1.4"
...
export archiso_link="http://arch.localmsp.org/arch/iso/2016.02.01/archlinux-2016.02.01-dual.iso"
