...
lang_config() {
	...
	case "$ILANG" in
		...
		;;
		"Swedish")
			export lang_file=/usr/share/arch-anywhere/arch-installer-swedish.conf
			export lang_link="https://raw.githubusercontent.com/deadhead420/arch-linux-anywhere/master/lang/arch-installer-swedish.conf"
		;;
	esac
