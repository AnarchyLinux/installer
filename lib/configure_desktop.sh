	  ...
	  do
		case "$env" in
			...
			"Anarchy-openbox")	config_env="$env"
						...
						DE+="openbox thunar thunar-volman xfce4-terminal xfce4-panel xfwm4 xfce4-whiskermenu-plugin xcompmgr transset-df obconf lxappearance-obconf wmctrl gxmessage xfce4-pulseaudio-plugin xfdesktop xdotool opensnap ristretto oblogout obmenu-generator openbox-themes $extras "
			;;
			...
			"KDE plasma")	start_term="exec startkde"
					...
					if (dialog --defaultno --yes-button "$yes" --no-button "$no" --yesno "\n$extra_msg3" 10 60) then
						...
						DE+="plasma ark aspell-en cdrdao clementine dolphin dolphin-plugins ffmpegthumbs gwenview k3b kate kcalc kdialog kfind kdeconnect kdegraphics-thumbnailers kdenetwork-filesharing kdenetwork-kopete kdesu kdelibs4support kipi-plugins khelpcenter konsole kwalletmanager okular spectacle transmission-qt krita kolourpaint korganizer knetattach qupzilla kdenlive "
					fi
