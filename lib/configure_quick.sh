...
quick_install() {
    ...
    case "$install_opt" in
        Anarchy-Desktop)    kernel="linux"
                            ...
                            dhcp=true
                            desktop=true
                            base_install="base-devel linux-headers lsb-release zsh zsh-syntax-highlighting grub dialog networkmanager wireless_tools wpa_supplicant wpa_actiond os-prober "
        ...
        Anarchy-Desktop-LTS)    kernel="linux-lts"
                                ...
                                dhcp=true
                                desktop=true
                                base_install="base-devel linux-lts linux-lts-headers lsb-release zsh zsh-syntax-highlighting grub dialog networkmanager wireless_tools wpa_supplicant wpa_actiond os-prober "
